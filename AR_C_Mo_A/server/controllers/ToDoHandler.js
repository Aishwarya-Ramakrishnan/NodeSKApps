...
function create(request,response){
    logger.log("info","POST request received Body:"+JSON.stringify(request.body));
...
function update(request, response) {
    logger.log("info","PUT request received Parameters:"+JSON.stringify(request.params)+"\nBody :"+JSON.stringify(request.body));
...
function remove(request, response) {
    logger.log("info", "DELETE request received Parameters:" + JSON.stringify(request.params));
